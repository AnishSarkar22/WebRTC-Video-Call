<script lang="ts">
	...
	function setRemoteVideoSource(
		element: HTMLVideoElement,
		params: { stream: MediaStream; userId: string }
	) {
	...
	{:else}
		<div class="video-call-container">
			...
			<div class="control-bar">
				...
				<button onclick={leaveRoom} class="leave-button"> Leave Call </button>
			</div>
			...
			<div class="video-grid" class:has-remote-users={remoteStreams.size > 0}>
				...
				<div class="main-video-container">
					<video bind:this={localVideo} autoplay muted playsinline class="main-video"></video>
							...
							<div class="remote-video-card">
								...
								<div class="remote-user-overlay">
									...
									<div
										...
										class:connected={peerConnections.get(remoteUserId)?.connectionState ===
											'connected'}
									>
			...
			<details class="debug-info">
				...
				<div class="debug-content">
					...
					{#if peerConnections.size > 0}
						...
						<ul>
							{#each Array.from(peerConnections.entries()) as [userId, pc] (userId)}
			...
			{#if webSocketService.errors.length > 0}
				<div class="error-notifications">
					{#each webSocketService.errors as error (error.errorCode)}
